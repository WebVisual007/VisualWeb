...
// FORZAR OCULTAR EL MODAL AL INICIO
// (por si el HTML viene sin la clase .hidden o algo lo abre)
...
function makeInteractable(el) {
  interact(el)
    ...
    .resizable({
      ...
      listeners: {
        move(event) {
          let dx = event.deltaRect.left;
          let dy = event.deltaRect.top;
